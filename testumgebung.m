...
SMPC = Sensorik(70,23,0.01); %Sensorobjekt hinzuf�gen
RADAR = Sensorik(240,9,0.01); %Sensorobjekt hinzuf�gen
...
for i = 1:10000
  ...
  [xr_new,yr_new,xl_new,yl_new] = ver.centerStreet(100); % neue Stra�e ermitteln (Koordinaten)
